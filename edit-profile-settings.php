            ...
            <div class="col-md-7">
              ...
              <div class="edit-profile-container">
                <div class="block-title">
                  ...
                  <div class="line"></div>
                  <p>Vous pouvez modifier vos préfences ici</p>
                  <div class="line"></div>
                </div>
                      ...
                      <div class="col-sm-9">
                        <div class="switch-description">
                          ...
                          <p>Vous entendrez un son quand quelqu'un vous envoi un message privé</p>
												...
												<div class="line"></div>
												<div><strong>Autoriser la géolocalisation</strong></div>
												<p>Permettre à l'application de vous géolocaliser ou non</p>

												<FORM>
														<input type= "radio" name="invisible" value="invisible"> Invisible
														<input type= "radio" name="amis" value="amis"> Amis seulement
														<input type= "radio" name="all" value="all"> Tout le monde
												</FORM>
